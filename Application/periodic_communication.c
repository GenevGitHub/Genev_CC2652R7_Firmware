...
void periodic_communication_MCUSampling()
{
    ...
    ptr_pc_MCUDArray->bat_voltage_mV = 40700;//7200 *sin(PI_CONSTANT * xtt * 0.0075) + 39000;   // simulate over-voltage, voltage-normal and under-voltage.  unit in mV
...
void periodic_communication_MCUSamplingRPM()
{
    ...
    int32_t rawRPM = 550; //300 * sin(PI_CONSTANT * 0.0075 * xrpm ) + 270;  // 264;  //dummy data - get RPM from MCU:  unit in rpm.  20 secs per cycle = 0.05 Hz;
